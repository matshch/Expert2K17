...
import { Badge, Row, Col, ListGroup, Card, CardBlock } from "reactstrap";
...
export class Panel extends React.Component<PanelProps, {}> {
    ...
    render() {
        if (this.props.user === null || this.props.user === undefined || this.props.user.isAdmin === false)
                        ...
                        <CardBlock>
                            ...
                            <Row>
                                <Col xs>
                                    ...
                                    <ListGroup>
                                        {this.props.UsersList.map(e => <PanelListItem text={e.userName} />)}
                                    </ListGroup>
                                </Col>
                                <Col xs>
                                    <h5>Список тестов:</h5>

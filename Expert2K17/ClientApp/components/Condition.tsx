...
import { Nav, NavItem, Row, Container, Col, Button, Form, FormGroup, Label, Input, FormText, Media, Card, CardTitle, CardText, ListGroup, ListGroupItem, ListGroupItemText } from 'reactstrap'
...
class Condition extends React.Component<ConditionProps, {}>{
    ...
    onVLeftChange = (item: any) => {
        ...
        if (typeof item == 'undefined' && this.props.type == Interf.ComponentCondition.Question) {
            this.props.deleteQuestionCondition(this.props.condition.guid);
            return;
        }

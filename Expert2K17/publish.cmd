...
bash -c "rsync -avzO --progress --exclude connections.json --exclude wwwroot/covers --exclude wwwroot/systems --exclude wwwroot/userpics --delete * maxis.pw:/opt/Expert2k17/"
